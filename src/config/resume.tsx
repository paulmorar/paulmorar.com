...
export const DATA = {
  ...
  summary:
    "Curious by nature and with a focused hands-on approach, I have been involved in building various market leading products from e-commerce to trading applications. When I do not code, I split my time between family and community. I co-organise the Copenhagen React meetup and am part of various other programming related communities in Copenhagen.",
  avatarUrl:
